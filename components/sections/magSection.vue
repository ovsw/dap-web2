<template>
  ...
  >
    <div class="[ magSection__image ] md:mr-grd">
      <img
        v-if="!section.video"
    ...
    >
      ...
      <div class="magSection__subHeadingWrapper">
        <h3 class="[ subtitle ] uppercase font-bold text-lg tracking-wide">
          {{ section.subtitle }}
        </h3>
        <!-- <p>{{section.theme}}</p>
      ...
      <div class="magSection__rteWrapper [ flow ] ">
        ...
        />
        <p>
          Hot Ride, Cool Slides, and America's Best Amusement Park Food! Hot
          Ride, Cool Slides, and America's Best Amusement Park Food! Hot Ride,
          Cool Slides, and America's Best Amusement Park Food!
        </p>
      </div>
