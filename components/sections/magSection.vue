    ...
    <div class="[ magSection__content ] [ pannel frame-thick flow ]">
      ...
      <h2>{{section.title}}</h2>
        ...
        <div class="magSection__subHeadingWrapper">
          <h3 class="[ subtitle ]">There is something for every age!</h3> 
        </div>
      
      <div class="magSection__rteWrapper [ flow ]">
        <p>Enjoy a Full Day of Water Park &amp; Rides with your All-Day Fun Pass!   The Laguna Splash Water Park Includes:</p>
        <ul>
        <li>River Lazio - Lazy River</li>
        <li>Wave Oceano - Wave Pool</li>
        <li>Bambini Cove</li>
        <li>Laguna Slides</li>
        <li>Laguna Waterworks</li>
        </ul>
      </div>
